...
document.addEventListener("DOMContentLoaded", function() {
  ...
  createParticles('particles-hero', {
    color: "#ffffff",
    opacity: 0.6,
    value: 160,        // Reduced from 200/120 to just 50
    ...
    lineLinked: {
      ...
      opacity: 0.5    // Lower opacity for connections
    }
  });
  
  // Create particles for products section with edge shape and repulse
  createParticles('particles-products', {
    color: "#dd0000",
    opacity: 0.25,
    shape: "edge", // Square particles
    value: 60, // Fewer particles for better performance
    interactivity: {
      events: {
        onclick: {
          enable: true,
